  ...
  charts &&
    charts.forEach(item => {
      var getcelldata = luckysheet_getcelldata(
        sheetInfo.name + "!" + item.chartOptions.rangeTxt
      );
      if (
  ...
  return {
    ...
    rangeResizeDraging: function (event, sheetBarHeight, statisticBarHeight) {
      ...
      if ($id == "luckysheet-chart-rangeShow-content") {
        ...
        if (rangeRowCheck.exits) {
          var row_s =
            r1 - chartInfo.chart_selection.rangeResizexy[0] + row_index;
          ...
          var row_s =
            st_r - chartInfo.chart_selection.rangeResizexy[0] + row_index;
        ...
        if (rangeColCheck.exits) {
          var col_s =
            c1 - chartInfo.chart_selection.rangeResizexy[1] + col_index;
          ...
          var col_s =
            st_c - chartInfo.chart_selection.rangeResizexy[1] + col_index;
...
function showNeedRangeShow(chart_id) {
  let chartLists =
    chartInfo.luckysheetfile[getSheetIndex(chartInfo.currentSheetIndex)].chart;
