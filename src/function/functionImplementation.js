...
const functionImplementation = {
    ...
    try {
      ...
      for (var i = 0; i < arguments.length; i++) {
        ...
        if (getObjType(data) === "array") {
          if (
            getObjType(data[0]) === "array" &&
            !func_methods.isDyadicArr(data)
          ) {
            return formula.error.v;
          }
          ...
          dataArr = dataArr.concat(
            func_methods.getCellDataArr(data, "number", true)
          );
        } else {
          if (!isRealNum(data)) {
      ...
      for (var i = 0; i < dataArr.length; i++) {
        ...
        if (isRealNum(dataArr[i])) {
          nums.push(parseFloat(dataArr[i]));
        }
      }
      ...
      variance = variance / (nums.length - 1); // 样本标准差使用 n-1
    ...
    try {
      ...
      for (var i = 0; i < arguments.length; i++) {
        ...
        if (getObjType(data) == "array") {
          ...
          dataArr = dataArr.concat(
            func_methods.getCellDataArr(data, "text", true)
          );
        } else {
          dataArr.push(data);
        }
  ...
  BIRTHDAY_BY_IDCARD: function () {
    ...
    try {
      ...
      if (UUserCard.length == 15) {
        var year =
          "19" +
          UUserCard.substring(6, 8) +
          "/" +
          UUserCard.substring(8, 10) +
          "/" +
    ...
    try {
      ...
      $.post(
        ...
        function (data) {
          ...
          jfrefreshgrid(d, [
            { row: [cell_r, cell_r], column: [cell_c, cell_c] },
          ]);
        }
      );
    ...
    try {
      ...
      if (arguments[1] != null) {
        ...
        if (getObjType(data_date) == "array") {
          ...
          getObjType(data_date) == "object" &&
          data_date.startCell != null
        ) {
          if (
            data_date.data != null &&
    ...
    try {
      ...
      if (arguments[2]) {
        ...
        if (rangeRow == sumRangeRow && rangeCol == sumRangeCol) {
          ...
          realSumRange =
            sumRangeSheet + "!" + sumRangeStart + ":" + sumRangeEnd;
    ...
    try {
      ...
      if (getObjType(data) == "array") {
        ...
        if (data.rowl > 1) {
          ...
          if (
            window.luckysheetCurrentRow < str ||
            window.luckysheetCurrentRow > str + data.rowl - 1
          ) {
            return formula.error.v;
          }
  ...
  COMBIN: function () {
    ...
    try {
      ...
      //计算结果
      return (
        func_methods.factorial(number) /
        (func_methods.factorial(number_chosen) *
          func_methods.factorial(number - number_chosen))
      );
    } catch (e) {
      var err = e;
      err = formula.errorInfo(err);
  ...
  SUBTOTAL: function () {
    ...
    try {
      ...
      if (getObjType(data_function_num) == "array") {
        ...
        getObjType(data_function_num) == "object" &&
        data_function_num.startCell != null
      ) {
      ...
      if (getObjType(function_num) == "array") {
        ...
        if (
          function_num < 1 ||
          function_num > 111 ||
          (function_num > 11 && function_num < 101)
        ) {
          return formula.error.v;
        }
      ...
      function compute(function_num) {
        switch (function_num) {
          case 1: //AVERAGE
          case 101:
            return window.luckysheet_function.AVERAGE.f.apply(
              window.luckysheet_function.AVERAGE,
              arr
            );
            break;
          case 2: //COUNT
          case 102:
            return window.luckysheet_function.COUNT.f.apply(
              window.luckysheet_function.COUNT,
              arr
            );
            break;
          case 3: //COUNTA
          case 103:
            return window.luckysheet_function.COUNTA.f.apply(
              window.luckysheet_function.COUNTA,
              arr
            );
            break;
          case 4: //MAX
          case 104:
            return window.luckysheet_function.MAX.f.apply(
              window.luckysheet_function.MAX,
              arr
            );
            break;
          case 5: //MIN
          case 105:
            return window.luckysheet_function.MIN.f.apply(
              window.luckysheet_function.MIN,
              arr
            );
            break;
          case 6: //PRODUCT
          case 106:
            return window.luckysheet_function.PRODUCT.f.apply(
              window.luckysheet_function.PRODUCT,
              arr
            );
            break;
          case 7: //STDEV
          case 107:
            return window.luckysheet_function.STDEVA.f.apply(
              window.luckysheet_function.STDEVA,
              arr
            );
            break;
          case 8: //STDEVP
          case 108:
            return window.luckysheet_function.STDEVP.f.apply(
              window.luckysheet_function.STDEVP,
              arr
            );
            break;
          case 9: //SUM
          case 109:
            return window.luckysheet_function.SUM.f.apply(
              window.luckysheet_function.SUM,
              arr
            );
            break;
          case 10: //VAR
          case 110:
            return window.luckysheet_function.VAR_S.f.apply(
              window.luckysheet_function.VAR_S,
              arr
            );
            break;
          case 11: //VARP
          case 111:
            return window.luckysheet_function.VAR_P.f.apply(
              window.luckysheet_function.VAR_P,
              arr
            );
            break;
        }
  ...
  COUNTIF: function () {
    ...
    try {
      ...
      if (getObjType(data_criteria) == "array") {
        ...
        getObjType(data_criteria) == "object" &&
        data_criteria.startCell != null
      ) {
              ...
              if (range[i][j] != null && !isRealNull(range[i][j].v)) {
                ...
                if (criter.indexOf("*") > -1 || criter.indexOf("?") > -1) {
                  ...
                  if (typeof value !== "string") {
                    ...
                    if (
                      new Function("return " + '"' + value + '"' + criter)()
                    ) {
                      matches++;
                    }
                  }
  ...
  FLOOR: function () {
    ...
    try {
      ...
      var precision = -Math.floor(
        Math.log(Math.abs(significance)) / Math.log(10)
      );
      ...
      if (number >= 0) {
        ...
        return (
          -(
            Math.ceil(Math.abs(number) / significance) *
            significance *
            Math.pow(10, precision)
          ) / Math.pow(10, precision)
        );
    ...
    try {
      ...
      for (var i = 0; i < arguments.length; i++) {
        ...
        if (getObjType(data) == "array") {
          ...
          dataArr = dataArr.concat(
            func_methods.getCellDataArr(data, "number", false)
          );
        } else {
          dataArr.push(data);
        }
  ...
  ROUND: function () {
    ...
    try {
      ...
      return (
        (sign * Math.round(Math.abs(number) * Math.pow(10, digits))) /
        Math.pow(10, digits)
      );
    } catch (e) {
      var err = e;
  ...
  SERIESSUM: function () {
    ...
    try {
      ...
      if (getObjType(data_coefficients) == "array") {
        if (
          getObjType(data_coefficients[0]) == "array" &&
          !func_methods.isDyadicArr(data_coefficients)
        ) {
          return formula.error.v;
        }

        coefficients = coefficients.concat(
          func_methods.getDataArr(data_coefficients, false)
        );
      } else if (
        getObjType(data_coefficients) == "object" &&
        data_coefficients.startCell != null
      ) {
        coefficients = coefficients.concat(
          func_methods.getCellDataArr(data_coefficients, "number", false)
        );
      } else {
    ...
    try {
      ...
      setTimeout(() => {
        ...
        if (rowheight >= d.length && colwidth >= d[0].length) {
          d = datagridgrowth(
            d,
            rowheight - d.length + 1,
            colwidth - d[0].length + 1
          );
  ...
  HYPGEOMDIST: function () {
    ...
    try {
      ...
      if (
        sample_s < 0 ||
        sample_s > Math.min(number_sample, population_s) ||
        sample_s < Math.max(0, number_sample - number_pop + population_s)
      ) {
        return formula.error.nm;
      }
      ...
      function pdf(x, n, M, N) {
        var a =
          func_methods.factorial(M) /
          (func_methods.factorial(x) * func_methods.factorial(M - x));
        var b =
          func_methods.factorial(N - M) /
          (func_methods.factorial(n - x) *
            func_methods.factorial(N - M - n + x));
        var c =
          func_methods.factorial(N) /
          (func_methods.factorial(n) * func_methods.factorial(N - n));
  ...
  INTERCEPT: function () {
    ...
    try {
      ...
      if (getObjType(data_known_y) == "array") {
        if (
          getObjType(data_known_y[0]) == "array" &&
          !func_methods.isDyadicArr(data_known_y)
        ) {
          return formula.error.v;
        }
        ...
        getObjType(data_known_y) == "object" &&
        data_known_y.startCell != null
      ) {
        known_y = known_y.concat(
          func_methods.getCellDataArr(data_known_y, "text", false)
        );
      } else {
      ...
      if (getObjType(data_known_x) == "array") {
        if (
          getObjType(data_known_x[0]) == "array" &&
          !func_methods.isDyadicArr(data_known_x)
        ) {
          return formula.error.v;
        }
        ...
        getObjType(data_known_x) == "object" &&
        data_known_x.startCell != null
      ) {
        known_x = known_x.concat(
          func_methods.getCellDataArr(data_known_x, "text", false)
        );
      } else {
  ...
  KURT: function () {
    ...
    try {
      ...
      if (
        dataArr_n.length < 4 ||
        func_methods.standardDeviation_s(dataArr_n) == 0
      ) {
        return formula.error.d;
      }
  ...
  LARGE: function () {
    ...
    try {
      ...
      if (getObjType(arguments[0]) == "array") {
        if (
          getObjType(arguments[0][0]) == "array" &&
          !func_methods.isDyadicArr(arguments[0])
        ) {
          return formula.error.v;
        }
        ...
        dataArr = dataArr.concat(
          func_methods.getCellDataArr(arguments[0], "text", true)
        );
      } else {
      ...
      if (getObjType(arguments[1]) == "array") {
        if (
          getObjType(arguments[1][0]) == "array" &&
          !func_methods.isDyadicArr(arguments[1])
        ) {
          return formula.error.v;
        }
        ...
        getObjType(arguments[1]) == "object" &&
        arguments[1].startCell != null
      ) {
    ...
    try {
      ...
      for (var i = 0; i < arguments.length; i++) {
        ...
        if (getObjType(data) == "array") {
          ...
          dataArr = dataArr.concat(
            func_methods.getCellDataArr(data, "text", false)
          );
        } else {
          dataArr.push(data);
        }
  ...
  RANK_EQ: function () {
    ...
    try {
      ...
      if (getObjType(data_ref) == "array") {
        if (
          getObjType(data_ref[0]) == "array" &&
          !func_methods.isDyadicArr(data_ref)
        ) {
          return formula.error.v;
        }
        ...
        getObjType(data_ref) == "object" &&
        data_ref.startCell != null
      ) {
    ...
    try {
      ...
      if (arguments.length == 3) {
        ...
        if (getObjType(order) == "boolean") {
          ...
          getObjType(order) == "string" &&
          (order.toLowerCase() == "true" || order.toLowerCase() == "false")
        ) {
      ...
      return count > 1
        ? (2 * ref_n.indexOf(number) + count + 1) / 2
        : ref_n.indexOf(number) + 1;
    } catch (e) {
      var err = e;
      err = formula.errorInfo(err);
      return [formula.error.v, err];
  ...
  AVEDEV: function () {
    ...
    try {
      ...
      return (
        jStat.sum(jStat(dataArr_n).subtract(jStat.mean(dataArr_n)).abs()[0]) /
        dataArr_n.length
      );
    } catch (e) {
      var err = e;
  ...
  TRIMMEAN: function () {
    ...
    try {
      ...
      if (getObjType(data_dataArr) == "array") {
        if (
          getObjType(data_dataArr[0]) == "array" &&
          !func_methods.isDyadicArr(data_dataArr)
        ) {
          return formula.error.v;
        }
        ...
        getObjType(data_dataArr) == "object" &&
        data_dataArr.startCell != null
      ) {
        dataArr = dataArr.concat(
          func_methods.getCellDataArr(data_dataArr, "number", false)
        );
      } else {
      ...
      var trim =
        window.luckysheet_function.FLOOR.f(dataArr_n.length * percent, 2) / 2;
  ...
  PERCENTILE_EXC: function () {
    ...
    try {
      ...
      return l === fl
        ? dataArr_n[l]
        : dataArr_n[fl] + (l - fl) * (dataArr_n[fl + 1] - dataArr_n[fl]);
    } catch (e) {
      var err = e;
      err = formula.errorInfo(err);
      return [formula.error.v, err];
  ...
  Z_TEST: function () {
    ...
    try {
      ...
      //计算
      var n = dataArr_n.length;
      var mean = window.luckysheet_function.AVERAGE.f.apply(
        window.luckysheet_function.AVERAGE,
        dataArr_n
      );
      ...
      return (
        1 -
        window.luckysheet_function.NORM_S_DIST.f(
          (mean - x) / (sigma / Math.sqrt(n)),
          "true"
        )
      );
    } catch (e) {
  ...
  PROB: function () {
    ...
    try {
      ...
      if (getObjType(arguments[0]) == "array") {
        ...
        data_x_range = data_x_range.concat(
          func_methods.getDataArr(arguments[0], false)
        );
      } else if (
        getObjType(arguments[0]) == "object" &&
        arguments[0].startCell != null
        ...
        data_x_range = data_x_range.concat(
          func_methods.getCellDataArr(arguments[0], "text", false)
        );
      } else {
      ...
      if (getObjType(arguments[1]) == "array") {
        ...
        data_prob_range = data_prob_range.concat(
          func_methods.getDataArr(arguments[1], false)
        );
      } else if (
        getObjType(arguments[1]) == "object" &&
        arguments[1].startCell != null
        ...
        data_prob_range = data_prob_range.concat(
          func_methods.getCellDataArr(arguments[1], "text", false)
        );
      } else {
      ...
      for (var i = 0; i < data_x_range.length; i++) {
        ...
        if (isRealNum(num_x_range) && isRealNum(num_prob_range)) {
          ...
          if (
            parseFloat(num_prob_range) <= 0 ||
            parseFloat(num_prob_range) > 1
          ) {
            return formula.error.nm;
          }
        }
  ...
  QUARTILE_EXC: function () {
    ...
    try {
      ...
      if (getObjType(arguments[0]) == "array") {
        ...
        data_array = data_array.concat(
          func_methods.getDataArr(arguments[0], true)
        );
      } else if (
        getObjType(arguments[0]) == "object" &&
        arguments[0].startCell != null
  ...
  T_DIST: function () {
    ...
    try {
      ...
      return cumulative
        ? jStat.studentt.cdf(x, degrees_freedom)
        : jStat.studentt.pdf(x, degrees_freedom);
    } catch (e) {
      var err = e;
      err = formula.errorInfo(err);
      return [formula.error.v, err];
    ...
    try {
      ...
      if (type == 1) {
        ...
        switch (type) {
          ...
          case 3:
            df =
              Math.pow(s_x / data_x.length + s_y / data_y.length, 2) /
              (Math.pow(s_x / data_x.length, 2) / (data_x.length - 1) +
                Math.pow(s_y / data_y.length, 2) / (data_y.length - 1));
            break;
        }
      }
  ...
  F_DIST: function () {
    ...
    try {
      ...
      return cumulative
        ? jStat.centralF.cdf(x, degrees_freedom1, degrees_freedom2)
        : jStat.centralF.pdf(x, degrees_freedom1, degrees_freedom2);
    } catch (e) {
      var err = e;
      err = formula.errorInfo(err);
      return [formula.error.v, err];
  ...
  SMALL: function () {
    ...
    try {
      ...
      if (getObjType(arguments[0]) == "array") {
        ...
        dataArr = dataArr.concat(
          func_methods.getCellDataArr(arguments[0], "number", true)
        );
      } else {
        if (!isRealNum(arguments[0])) {
          return formula.error.v;
  ...
  SKEW: function () {
    ...
    try {
      ...
      return (
        (n * sigma) /
        ((n - 1) * (n - 2) * Math.pow(jStat.stdev(dataArr_n, true), 3))
      );
    } catch (e) {
      var err = e;
      err = formula.errorInfo(err);
        ...
        if (formula.execFunctionGlobalData != null) {
          let ef =
            formula.execFunctionGlobalData[
              row + "_" + col + "_" + Store.calculateSheetIndex
            ];
          if (ef != null) {
            value = ef.v;
          }
  ...
  OFFSET: function () {
    ...
    try {
      ...
      if (
        !(
          getObjType(arguments[0]) == "object" && arguments[0].startCell != null
        )
      ) {
        return formula.error.v;
      }
      ...
      if (
        cellRow0 < 0 ||
        cellRow1 >= sheetdata.length ||
        cellCol0 < 0 ||
        cellCol1 >= sheetdata[0].length
      ) {
        return formula.error.r;
      }
      ...
      for (var r = cellRow0; r <= cellRow1; r++) {
        ...
        for (var c = cellCol0; c <= cellCol1; c++) {
          if (
            ...
            formula.execFunctionGlobalData[
              r + "_" + c + "_" + Store.calculateSheetIndex
            ] != null
          ) {
            let ef =
              formula.execFunctionGlobalData[
  ...
  MATCH: function () {
    ...
    try {
      ...
      if (getObjType(data_lookup_array) == "array") {
        ...
        getObjType(data_lookup_array) == "object" &&
        data_lookup_array.startCell != null
      ) {
          ...
          if (getObjType(data_lookup_array.data) == "array") {
            for (var i = 0; i < data_lookup_array.data.length; i++) {
              for (var j = 0; j < data_lookup_array.data[i].length; j++) {
                if (
                  data_lookup_array.data[i][j] != null &&
                  !isRealNull(data_lookup_array.data[i][j].v)
                ) {
      ...
      for (var idx = 0; idx < lookup_array.length; idx++) {
        if (match_type === 1) {
          ...
          if (typeof lookup_value === "string") {
            ...
            if (
              lookup_array[idx].toLowerCase().match(lookup_value.toLowerCase())
            ) {
              return idx + 1;
            }
          } else {
  ...
  VLOOKUP: function () {
    ...
    try {
      ...
      if (getObjType(data_table_array) == "array") {
        ...
        getObjType(data_table_array) == "object" &&
        data_table_array.startCell != null
      ) {
        table_array = func_methods.getCellDataDyadicArr(
          data_table_array,
          "text"
        );
      } else {
  ...
  INDEX: function () {
    ...
    try {
      ...
      if (getObjType(data_array) == "array") {
        if (
          getObjType(data_array[0]) == "array" &&
          !func_methods.isDyadicArr(data_array)
        ) {
          return formula.error.v;
        }
        ...
        getObjType(data_array) == "object" &&
        data_array.startCell != null
      ) {
  ...
  CHOOSE: function () {
    ...
    try {
      ...
      if (getObjType(data_result) == "array") {
        if (
          getObjType(data_result[0]) == "array" &&
          !func_methods.isDyadicArr(data_result)
        ) {
          return formula.error.v;
        }
        ...
        getObjType(data_result) == "object" &&
        data_result.startCell != null
      ) {
        ...
        if (getObjType(data_result.data) == "array") {
          var result = func_methods.getCellDataDyadicArr(
            data_result.data,
            "number"
          );
  ...
  TIMEVALUE: function () {
    ...
    try {
      ...
      return (
        (3600 * dayjs(time_text).get("hour") +
          60 * dayjs(time_text).get("minute") +
          dayjs(time_text).get("second")) /
        86400
      );
    } catch (e) {
      var err = e;
  ...
  NETWORKDAYS: function () {
    ...
    try {
      if (arguments.length == 3) {
        var result = window.luckysheet_function.NETWORKDAYS_INTL.f(
          arguments[0],
          arguments[1],
          1,
          arguments[2]
  ...
  DAYS360: function () {
    ...
    try {
      ...
      if (method) {
        ...
        var smd = dayjs()
          .set({ year: dayjs(start_date).year(), month: sm + 1, date: 0 })
          .date();
        var emd = dayjs()
          .set({ year: dayjs(end_date).year(), month: em + 1, date: 0 })
          .date();
      ...
      var result =
        360 * dayjs(end_date).diff(dayjs(start_date), "years") +
        30 * (em - sm) +
        (ed - sd);
  ...
  WORKDAY: function () {
    ...
    try {
      if (arguments.length == 3) {
        var result = window.luckysheet_function.WORKDAY_INTL.f(
          arguments[0],
          arguments[1],
          1,
          arguments[2]
      ...
      switch (basis) {
        ...
        case 1: // Actual/actual
          ...
          if (
            ...
            if (
              (sy === ey && func_methods.isLeapYear(sy)) ||
          ...
          var years = ey - sy + 1;
          var days =
            (dayjs().set({ year: ey + 1, month: 0, date: 1 }) -
              dayjs().set({ year: sy, month: 0, date: 1 })) /
            1000 /
            60 /
            60 /
            24;
  ...
  DOLLAR: function () {
    ...
    try {
      ...
      return (
        (sign * Math.floor(Math.abs(number) * Math.pow(10, decimals))) /
  ...
  RATE: function () {
    ...
    try {
      ...
      while (iter < iterMax && !close) {
        ...
        var f2 =
          nper * t2 * pv -
          (pmt * (t1 - 1) * (rate * type + 1)) / Math.pow(rate, 2);
        var f3 =
    ...
    try {
      ...
      for (var i = start_period; i <= end_period; i++) {
        if (type > 0) {
          principal +=
            payment -
            (window.luckysheet_function.FV.f(rate, i - 2, payment, pv, 1) -
              payment) *
              rate;
        } else {
          principal +=
            payment -
            window.luckysheet_function.FV.f(rate, i - 1, payment, pv, 0) * rate;
        }
      }
      ...
      switch (basis) {
        ...
        case 1: // Actual/actual
          ...
          if (
            ...
            if (
              (sy === ey && func_methods.isLeapYear(sy)) ||
              func_methods.feb29Between(settlement, maturity) ||
              (em === 1 && ed === 29)
            ) {
              ylength = 366;
            }
            ...
            return (
              dayjs(maturity).diff(dayjs(settlement), "days") /
              (ylength / frequency)
            );
          }
        ...
        case 2: // Actual/360
          result =
            dayjs(maturity).diff(dayjs(settlement), "days") / (360 / frequency);

          break;
        case 3: // Actual/365
          result =
            dayjs(maturity).diff(dayjs(settlement), "days") / (365 / frequency);
  ...
  TBILLEQ: function () {
    ...
    try {
      ...
      return (
        (365 * discount) /
        (360 - discount * dayjs(maturity).diff(dayjs(settlement), "days"))
      );
    } catch (e) {
      var err = e;
      err = formula.errorInfo(err);
  ...
  TBILLYIELD: function () {
    ...
    try {
      ...
      return (
        ((100 - pr) / pr) *
        (360 / dayjs(maturity).diff(dayjs(settlement), "days"))
      );
    } catch (e) {
      var err = e;
      err = formula.errorInfo(err);
  ...
  TBILLPRICE: function () {
    ...
    try {
      ...
      return (
        100 *
        (1 - (discount * dayjs(maturity).diff(dayjs(settlement), "days")) / 360)
      );
    } catch (e) {
      var err = e;
      err = formula.errorInfo(err);
  ...
  PV: function () {
    ...
    try {
      ...
      if (rate === 0) {
        ...
        var result =
          (((1 - Math.pow(1 + rate, nper)) / rate) * pmt * (1 + rate * type) -
            fv) /
        ...
        switch (basis) {
          ...
          case 1: // Actual/actual
            ...
            if (
              ...
              if (
                (sy === ey && func_methods.isLeapYear(sy)) ||
                func_methods.feb29Between(first_interest, settlement) ||
                (em === 1 && ed === 29)
              ) {
                ylength = 366;
              }
              ...
              return (
                dayjs(settlement).diff(dayjs(first_interest), "days") / ylength
              );
            }
            ...
            result =
              dayjs(settlement).diff(dayjs(first_interest), "days") / average;

            break;
          case 2: // Actual/360
            result =
              dayjs(settlement).diff(dayjs(first_interest), "days") / 360;

            break;
          case 3: // Actual/365
            result =
              dayjs(settlement).diff(dayjs(first_interest), "days") / 365;
        ...
        switch (basis) {
          ...
          case 1: // Actual/actual
            ...
            if (
              ...
              if (
                (sy === ey && func_methods.isLeapYear(sy)) ||
                func_methods.feb29Between(issue, settlement) ||
                (em === 1 && ed === 29)
              ) {
                ylength = 366;
              }
  ...
  COUPDAYBS: function () {
    ...
    try {
      ...
      var maxCount =
        Math.ceil(
          dayjs(maturity).diff(dayjs(settlement), "months") / (12 / frequency)
        ) + 1;
    ...
    try {
      ...
      switch (basis) {
        ...
        case 1: // Actual/actual
          var maxCount =
            Math.ceil(
              dayjs(maturity).diff(dayjs(settlement), "months") /
                (12 / frequency)
            ) + 1;
          ...
          for (var i = 1; i <= maxCount; i++) {
            ...
            if (d1 <= dayjs(settlement)) {
              var d2 = dayjs(maturity).subtract(
                (12 / frequency) * (i - 1),
                "months"
              );
  ...
  COUPDAYSNC: function () {
    ...
    try {
      ...
      for (var i = 1; i <= maxCount; i++) {
        ...
        if (di <= dayjs(settlement)) {
          interest = dayjs(maturity).subtract(
            (12 / frequency) * (i - 1),
            "months"
          );
          break;
  ...
  FVSCHEDULE: function () {
    ...
    try {
      ...
      if (getObjType(data_schedule) == "array") {
        if (
          getObjType(data_schedule[0]) == "array" &&
          !func_methods.isDyadicArr(data_schedule)
        ) {
          return formula.error.v;
        }

        schedule = schedule.concat(
          func_methods.getDataArr(data_schedule, false)
        );
      } else if (
        getObjType(data_schedule) == "object" &&
        data_schedule.startCell != null
      ) {
        schedule = schedule.concat(
          func_methods.getCellDataArr(data_schedule, "number", false)
        );
      } else {
  ...
  YIELD: function () {
    ...
    try {
      ...
      //计算
      var num = window.luckysheet_function.COUPNUM.f(
        settlement,
        maturity,
        frequency,
        basis
      ...
      if (num > 1) {
        ...
        for (var i = 1; i <= 100; i++) {
          var price = window.luckysheet_function.PRICE.f(
            settlement,
            maturity,
            rate,
            yld,
        ...
        var DSR = window.luckysheet_function.COUPDAYSNC.f(
          settlement,
          maturity,
          frequency,
          basis
        );
        var E = window.luckysheet_function.COUPDAYS.f(
          settlement,
          maturity,
          frequency,
          basis
        );
        var A = window.luckysheet_function.COUPDAYBS.f(
          settlement,
          maturity,
          frequency,
          basis
  ...
  YIELDDISC: function () {
    ...
    try {
      ...
      var yearfrac = window.luckysheet_function.YEARFRAC.f(
        settlement,
        maturity,
        basis
      );
  ...
  XIRR: function () {
    ...
    try {
      ...
      if (getObjType(data_values) == "array") {
        if (
          getObjType(data_values[0]) == "array" &&
          !func_methods.isDyadicArr(data_values)
        ) {
          return formula.error.v;
        }
        ...
        getObjType(data_values) == "object" &&
        data_values.startCell != null
      ) {
        values = values.concat(
          func_methods.getCellDataArr(data_values, "number", false)
        );
      } else {
      ...
      var irrResult = function (values, dates, rate) {
        ...
        for (var i = 1; i < values.length; i++) {
          result +=
            ...
            Math.pow(
              r,
              window.luckysheet_function.DAYS.f(dates[i], dates[0]) / 365
            );
        }
      ...
      do {
        ...
        newRate =
          resultRate -
          resultValue / irrResultDeriv(values_n, dates, resultRate);
  ...
  MIRR: function () {
    ...
    try {
      ...
      var num =
        -window.luckysheet_function.NPV.f(reinvest_rate, incomes) *
        Math.pow(1 + reinvest_rate, n - 1);
      var den =
        window.luckysheet_function.NPV.f(finance_rate, payments) *
        (1 + finance_rate);
  ...
  IRR: function () {
    ...
    try {
      ...
      if (getObjType(data_values) == "array") {
        ...
        values = values.concat(
          func_methods.getCellDataArr(data_values, "number", true)
        );
      } else {
        values.push(data_values);
      }
    ...
    try {
      ...
      for (var i = start_period; i <= end_period; i++) {
        if (type === 1) {
          ...
          interest += window.luckysheet_function.FV.f(
            rate,
            i - 1,
            payment,
            pv,
  ...
  IPMT: function () {
    ...
    try {
      ...
      if (per === 1) {
        ...
        if (type === 1) {
          interest =
            window.luckysheet_function.FV.f(rate, per - 2, payment, pv, 1) -
            payment;
        } else {
          interest = window.luckysheet_function.FV.f(
            rate,
  ...
  PPMT: function () {
    ...
    try {
      ...
      //计算
      var payment = window.luckysheet_function.PMT.f(rate, nper, pv, fv, type);
      var payment2 = window.luckysheet_function.IPMT.f(
        rate,
        per,
        nper,
        pv,
  ...
  PRICE: function () {
    ...
    try {
      ...
      //计算
      var DSC = window.luckysheet_function.COUPDAYSNC.f(
        settlement,
        maturity,
        frequency,
        basis
      ...
      if (num > 1) {
        ...
        for (var i = 1; i <= num; i++) {
          T2 +=
            (100 * rate) /
            frequency /
            Math.pow(1 + yld / frequency, i - 1 + DSC / E);
        }
      ...
      switch (basis) {
        ...
        case 1: // Actual/actual
          ...
          if (
            ...
            result =
              (100 + (DIM / B) * rate * 100) / (1 + (DSM / B) * yld) -
              (A / B) * rate * 100;
  ...
  DURATION: function () {
    ...
    try {
      ...
      var nper = window.luckysheet_function.COUPNUM.f(
        settlement,
        maturity,
        frequency,
        basis
      ...
      for (var i = 1; i <= nper; i++) {
        sum1 +=
          (100 * (coupon / frequency) * i) / Math.pow(1 + yld / frequency, i);
        sum2 += (100 * (coupon / frequency)) / Math.pow(1 + yld / frequency, i);
      }

      var result =
        (sum1 + (100 * nper) / Math.pow(1 + yld / frequency, nper)) /
        (sum2 + 100 / Math.pow(1 + yld / frequency, nper));
  ...
  MDURATION: function () {
    ...
    try {
      ...
      var duration = window.luckysheet_function.DURATION.f(
        settlement,
        maturity,
        coupon,
        yld,
  ...
  DEC2BIN: function () {
    ...
    try {
      ...
      if (number < 0) {
        return (
          "1" +
          new Array(9 - (512 + number).toString(2).length).join("0") +
  ...
  HEX2BIN: function () {
    ...
    try {
      ...
      if (negative) {
        return (
          "1" +
          new Array(9 - (512 + decimal).toString(2).length).join("0") +
    ...
    try {
      ...
      if (real_num === 0 && i_num === 0) {
        ...
        return (
          real_num.toString() +
          sign +
          (i_num === 1 ? suffix : i_num.toString() + suffix)
        );
      }
    } catch (e) {
      var err = e;
  ...
  IMCONJUGATE: function () {
    ...
    try {
      ...
      return y !== 0
        ? window.luckysheet_function.COMPLEX.f(x, -y, unit)
        : inumber;
    } catch (e) {
      var err = e;
      err = formula.errorInfo(err);
  ...
  IMSUB: function () {
    ...
    try {
      ...
      if (
        inumber1.toLowerCase() == "true" ||
        inumber1.toLowerCase() == "false"
      ) {
        return formula.error.v;
      }
      ...
      if (
        inumber2.toLowerCase() == "true" ||
        inumber2.toLowerCase() == "false"
      ) {
        return formula.error.v;
      }
  ...
  IMPRODUCT: function () {
    ...
    try {
      ...
      for (var i = 1; i < arguments.length; i++) {
        ...
        result = window.luckysheet_function.COMPLEX.f(
          a * c - b * d,
          a * d + b * c
        );
      }
  ...
  IMDIV: function () {
    ...
    try {
      ...
      return window.luckysheet_function.COMPLEX.f(
        (a * c + b * d) / den,
        (b * c - a * d) / den,
        unit
      );
  ...
  IFERROR: function () {
    ...
    try {
      ...
      if (
        valueIsError(value) ||
        (getObjType(value) === "string" && $.trim(value) === "")
      ) {
  ...
  REPLACE: function () {
    ...
    try {
      ...
      return (
        old_text.substr(0, start_num - 1) +
        new_text +
        old_text.substr(start_num - 1 + num_chars)
      );
    } catch (e) {
      var err = e;
      err = formula.errorInfo(err);
  ...
  SEARCH: function () {
    ...
    try {
      ...
      var foundAt =
        within_text
          .toLowerCase()
          .indexOf(find_text.toLowerCase(), start_num - 1) + 1;
  ...
  SUMX2MY2: function () {
    ...
    try {
      ...
      if (getObjType(data_array_x) == "array") {
        if (
          getObjType(data_array_x[0]) == "array" &&
          !func_methods.isDyadicArr(data_array_x)
        ) {
          return formula.error.v;
        }
        ...
        getObjType(data_array_x) == "object" &&
        data_array_x.startCell != null
      ) {
        array_x = array_x.concat(
          func_methods.getCellDataArr(data_array_x, "text", false)
        );
      } else {
      ...
      if (getObjType(data_array_y) == "array") {
        if (
          getObjType(data_array_y[0]) == "array" &&
          !func_methods.isDyadicArr(data_array_y)
        ) {
          return formula.error.v;
        }
        ...
        getObjType(data_array_y) == "object" &&
        data_array_y.startCell != null
      ) {
        array_y = array_y.concat(
          func_methods.getCellDataArr(data_array_y, "text", false)
        );
      } else {
    ...
    try {
      ...
      if (arguments.length >= 3) {
        ...
        if (getObjType(data_new_x) == "array") {
          if (
            getObjType(data_new_x[0]) == "array" &&
            !func_methods.isDyadicArr(data_new_x)
          ) {
            return formula.error.v;
          }
          ...
          getObjType(data_new_x) == "object" &&
          data_new_x.startCell != null
        ) {
      ...
      if (
        known_y_rowlen != known_x_rowlen ||
        known_y_collen != known_x_collen
      ) {
        return formula.error.r;
      }
  ...
  FREQUENCY: function () {
    ...
    try {
      ...
      if (getObjType(data_data_array) == "array") {
        if (
          getObjType(data_data_array[0]) == "array" &&
          !func_methods.isDyadicArr(data_data_array)
        ) {
          return formula.error.v;
        }

        data_array = data_array.concat(
          func_methods.getDataArr(data_data_array, true)
        );
      } else if (
        getObjType(data_data_array) == "object" &&
        data_data_array.startCell != null
      ) {
        data_array = data_array.concat(
          func_methods.getCellDataArr(data_data_array, "number", true)
        );
      } else {
      ...
      if (getObjType(data_bins_array) == "array") {
        if (
          getObjType(data_bins_array[0]) == "array" &&
          !func_methods.isDyadicArr(data_bins_array)
        ) {
          return formula.error.v;
        }

        bins_array = bins_array.concat(
          func_methods.getDataArr(data_bins_array, true)
        );
      } else if (
        getObjType(data_bins_array) == "object" &&
        data_bins_array.startCell != null
      ) {
        bins_array = bins_array.concat(
          func_methods.getCellDataArr(data_bins_array, "number", true)
        );
      } else {
      ...
      if (data_array_n.length == 0 && bins_array_n.length == 0) {
        ...
        for (var i = 0; i < bins_array_n.length; i++) {
          if (i == 0) {
            ...
            for (var j = 0; j < data_array_n.length; j++) {
              if (
                data_array_n[j] <= bins_array_n[i] &&
                data_array_n[j] > bins_array_n[i - 1]
              ) {
                count1++;
              }
  ...
  MMULT: function () {
    ...
    try {
      ...
      if (getObjType(data_array1) == "array") {
        if (
          getObjType(data_array1[0]) == "array" &&
          !func_methods.isDyadicArr(data_array1)
        ) {
          return formula.error.v;
        }
        ...
        getObjType(data_array1) == "object" &&
        data_array1.startCell != null
      ) {
      ...
      if (getObjType(data_array2) == "array") {
        if (
          getObjType(data_array2[0]) == "array" &&
          !func_methods.isDyadicArr(data_array2)
        ) {
          return formula.error.v;
        }
        ...
        getObjType(data_array2) == "object" &&
        data_array2.startCell != null
      ) {
  ...
  CELL: function () {
    ...
    try {
      ...
      if (getObjType(data_info_type) == "array") {
        ...
        getObjType(data_info_type) == "object" &&
        data_info_type.startCell != null
      ) {
      ...
      if (
        getObjType(data_reference) == "object" &&
        data_reference.startCell != null
      ) {
      ...
      if (
        formula.execFunctionGlobalData != null &&
        formula.execFunctionGlobalData[
          row_index + "_" + col_index + "_" + Store.calculateSheetIndex
        ] != null
      ) {
        value =
          formula.execFunctionGlobalData[
        ...
        sheetdata[row_index][col_index] != null &&
        sheetdata[row_index][col_index].v != null &&
        sheetdata[row_index][col_index].v != ""
      ) {
      ...
      switch (info_type) {
        ...
        case "format":
          if (
            sheetdata[row_index][col_index] == null ||
            sheetdata[row_index][col_index].ct == null
          ) {
            return "G";
          }
  ...
  ERROR_TYPE: function () {
    ...
    try {
      ...
      if (getObjType(data_error_val) == "array") {
        ...
        getObjType(data_error_val) == "object" &&
        data_error_val.startCell != null
      ) {
  ...
  ISERR: function () {
    ...
    try {
      ...
      if (getObjType(data_value) == "array") {
        ...
        getObjType(data_value) == "object" &&
        data_value.startCell != null
      ) {
      ...
      if (
        ["#VALUE!", "#REF!", "#DIV/0!", "#NUM!", "#NAME?", "#NULL!"].indexOf(
          value
        ) > -1
      ) {
        return true;
  ...
  DGET: function () {
    ...
    try {
      ...
      if (
        getObjType(data_database) == "object" &&
        data_database.startCell != null
      ) {
  ...
  FILTER: function () {
    ...
    try {
      ...
      if (getObjType(data_include) == "array") {
          ...
          if (data_include.length > 1) {
            ...
            for (var i = 0; i < data_include.length; i++) {
              ...
              if (getObjType(txt) == "boolean") {
                ...
                getObjType(txt) == "string" &&
                (txt.toLowerCase() == "true" || txt.toLowerCase() == "false")
              ) {
        ...
        getObjType(data_include) == "object" &&
        data_include.data != null &&
        getObjType(data_include.data) == "array"
      ) {
  ...
  EVALUATE: function () {
    ...
    try {
      ...
      //console.log(strtext);
      var result_this = formula.execstringformula(
        strtext,
        cell_r,
        cell_c,
        sheetindex_now
